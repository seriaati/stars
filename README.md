...
- [seriaati/lumina](https://github.com/seriaati/lumina) - Discord bot with birthday reminder, reminders, and todo list.
...
- [seriaati/enka-to-go](https://github.com/seriaati/enka-to-go) - Export your Enka Network showcase to Genshin/Zenless Optimizer.
...
- [sirilerklab/pyinitgen](https://github.com/sirilerklab/pyinitgen) - A CLI generate init python
...
- [sirilerklab/EnkaNetwork.py](https://github.com/sirilerklab/EnkaNetwork.py) - Library for fetching JSON data from site https://enka.network/ with Python
...
- [lingdojo/kana-dojo](https://github.com/lingdojo/kana-dojo) - Aesthetic, minimalist platform for learning Japanese inspired by Duolingo and Monkeytype, built with Next.js and powered by Vercel. Beginner-friendly with plenty of good first issues - all contributio
